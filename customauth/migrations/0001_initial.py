    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_supreme', models.BooleanField(help_text='Designates whether the user can ignore ownership of items.', verbose_name='supreme user status', default=False)),
                ('groups', models.ManyToManyField(blank=True, related_name='user_set', related_query_name='user', verbose_name='groups', help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', to='auth.Group')),
